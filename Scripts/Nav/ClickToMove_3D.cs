...
{	
	...
	void Awake()
    {
		...
		EventMgr.Instance.add_listener("UIMoveLock", SetOnClickUILock);
	}
    private void Start()
    {
	...
	void SetOnClickUILock(string uname , object udata)
    {
		OnClickUILock = (bool)udata;
	}
}